...
public class AdbConnectionManager extends AbsAdbConnectionManager {
    ...
    public static synchronized AbsAdbConnectionManager freshInstance(@NonNull Context context) throws Exception {
        if (INSTANCE != null) {
            try { INSTANCE.disconnect(); } catch (Throwable ignored) {}
        }
        INSTANCE = new AdbConnectionManager(context.getApplicationContext());
        return INSTANCE;
    }
    ...
    private AdbConnectionManager(@NonNull Context context) throws Exception {
        ...
        try {
            ...
            new File(context.getFilesDir(), "private.key").delete();
            new File(context.getFilesDir(), "cert.pem").delete();
            mPrivateKey = null;
            mCertificate = null;
        }
        if (mPrivateKey == null || mCertificate == null) {
            ...
            String subject = "CN=Sensor Lock";
            String algorithmName = "SHA512withRSA";
            long expiryDate = System.currentTimeMillis() + 315360000000L;
